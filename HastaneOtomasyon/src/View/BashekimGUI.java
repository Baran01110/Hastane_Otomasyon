...
public class BashekimGUI extends JFrame {
	...
	public BashekimGUI(Bashekim bashekim) throws SQLException {
		...
		lblNewLabel_1_1.setBounds(482, 61, 107, 27);
		...
		lblNewLabel_1_1_1.setBounds(482, 114, 107, 27);
		...
		scrollWorker.setBounds(429, 10, 208, 288);
		panelklinik.add(scrollWorker);
		
		tableworker = new JTable();
		scrollWorker.setViewportView(tableworker);
		
		JComboBox comboBoxdoktor = new JComboBox();
		comboBoxdoktor.setBounds(295, 212, 128, 29);
		for(int i=0; i<bashekim.getDoctorList().size() ; i++) {
			comboBoxdoktor.addItem(new Item(bashekim.getDoctorList().get(i).getId() , bashekim.getDoctorList().get(i).getName()));
		}
		comboBoxdoktor.addActionListener(e -> {
			JComboBox c = (JComboBox) e.getSource();
			Item item = (Item) c.getSelectedItem();
			System.out.println(item.getKey() + ":" + item.getValue());
		});
		panelklinik.add(comboBoxdoktor);
		...
		btnaddworker.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(selRow >= 0) {
					...
					Item doctorItem = (Item) comboBoxdoktor.getSelectedItem();
					try {
		...
		btnaddworker.setFont(new Font("Tahoma", Font.BOLD, 16));
		btnaddworker.setBounds(295, 254, 124, 29);
		panelklinik.add(btnaddworker);
		
		JLabel lblNewLabel_1_2_1 = new JLabel("Poliklinik Adı");
		lblNewLabel_1_2_1.setFont(new Font("Tahoma", Font.BOLD, 14));
		lblNewLabel_1_2_1.setBounds(295, 121, 102, 27);
		panelklinik.add(lblNewLabel_1_2_1);
		...
		btnWorkerSelect.setFont(new Font("Tahoma", Font.BOLD, 16));
		btnWorkerSelect.setBounds(295, 158, 124, 29);
		panelklinik.add(btnWorkerSelect);
	}
